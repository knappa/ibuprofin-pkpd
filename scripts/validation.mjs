...
// src/validation-data.js and write docs/VALIDATION.md.
//
// Run with: node scripts/validation.mjs
// The test suite imports runValidation() to guard against regressions.

import { writeFileSync } from "node:fs";
import { fileURLToPath } from "node:url";

import { simulate, patientPkParameters } from "../src/model.js";
import { peak, valueAt } from "../src/metrics.js";
...
function describeObserved(observation) {
  if (observation.mean !== undefined && observation.sd !== undefined) {
...
export function renderReport(studies) {
  ...
  const lines = [
    "# Model Validation",
    "",
    "GENERATED by `node scripts/validation.mjs`. Do not edit by hand.",
